...
## path
path = edict()
path.raw_path = "/content/visualDet3D/visualDet3D/data/kitti_raw"
path.depth_path = "/content/visualDet3D/visualDet3D/data/kitti_obj/data_depth_annotated/train"
path.validation_path = "/content/visualDet3D/visualDet3D/data/kitti_obj/data_depth_selection/depth_selection/val_selection_cropped"
path.test_path = "/content/visualDet3D/visualDet3D/data/kitti_obj/data_depth_selection/depth_selection/test_depth_prediction_anonymous"

path.visualDet3D_path = "/content/visualDet3D/visualDet3D" # The path should point to the inner subfolder
path.project_path = "/content/visualDet3D/workdirs" # or other path for pickle files, checkpoints, tensorboard logging and output files.
