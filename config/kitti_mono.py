...
## path
path = edict()
path.data_path = "/content/visualDet3D/visualDet3D/data/kitti_obj/training" # used in visualDet3D/data/.../dataset
path.test_path = "/content/visualDet3D/visualDet3D/data/kitti_obj/testing" # used in visualDet3D/data/.../dataset
